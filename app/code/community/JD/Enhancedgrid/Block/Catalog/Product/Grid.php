 ...
 */
class JD_Enhancedgrid_Block_Catalog_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $this->setTemplate('jd/enhancedgrid/catalog/product/grid.phtml');
        parent::__construct();
    ...
    /**
     * @return JD_Enhancedgrid_Model_Product_Grid_Settings_Columns
     */
    ...
    protected function _prepareCollection()
    {
        ...
        if (!$collection) {
            ...
            $collection = new JD_Enhancedgrid_Model_Resource_Eav_Mysql4_Product_Collection();
        }
