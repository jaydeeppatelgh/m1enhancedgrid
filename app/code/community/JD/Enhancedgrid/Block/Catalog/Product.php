 ...
 */
class JD_Enhancedgrid_Block_Catalog_Product extends Mage_Adminhtml_Block_Catalog_Product
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setTemplate('jd'.DS.'enhancedgrid'.DS.'catalog'.DS.'product.phtml');
