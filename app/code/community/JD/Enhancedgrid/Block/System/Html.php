 ...
 */
class JD_Enhancedgrid_Block_System_Html
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= '
            ...
            Enhanced Grid v'.Mage::getConfig()->getNode('modules/JD_Enhancedgrid/version').". <a href='https://github.com/jayelkaake/enhancedgrid' target='_blank'>Click here for updates.</a><BR />
		";
