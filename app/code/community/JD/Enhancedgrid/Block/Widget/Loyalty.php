 ...
 */
class JD_Enhancedgrid_Block_Widget_Loyalty extends Mage_Adminhtml_Block_Template
{
...
FEED;
    ...
    protected function _getLoyaltyUrl()
    {
        ...
        $url_data['v'] = (string) Mage::getConfig()->getNode('modules/JD_Enhancedgrid/version');
